...
ylim([0, yL]);  
hold on 
x_I = 100; y_I = 50;  % set initial point
x_G = 290; y_G = 238; % set target point
...
for iter = 1:1000
   ...
   x_rand = [unifrnd( X_near(1),300),unifrnd( X_near(2), 220)]; % Generate random points (x,y)
...
x_final = 400; y_final = 430;  % set target point
